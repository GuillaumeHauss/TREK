const es: Record<string, string> = {
  ...
  // Groceries
  'groceries.shopping': 'Lista de Compras',
  'groceries.recipes': 'Recetas',
  'groceries.addItems': 'Añadir Artículos',
  'groceries.ustensils': 'Utensilios',
  'groceries.newRecipe': 'Nueva Receta',
  'groceries.recipeName': 'Nombre de la receta',
  'groceries.description': 'Descripción',
  'groceries.servings': 'Porciones',
  'groceries.ingredients': 'Ingredientes',
  'groceries.ingredientName': 'Nombre del ingrediente',
  'groceries.quantity': 'Cantidad',
  'groceries.unit': 'Unidad',
  'groceries.domain': 'Categoría',
  'groceries.ustensilName': 'Nombre del utensilio',
  'groceries.save': 'Guardar',
  'groceries.cancel': 'Cancelar',
  'groceries.addToList': 'Añadir a la lista de compras',
  'groceries.sharedUstensils': 'Utensilios Compartidos',
  'groceries.noShared': 'Sin utensilios compartidos en múltiples recetas aún',
  'groceries.usedIn': 'Utilizado en {count} recetas',
  'groceries.itemAdded': 'Artículo añadido',
  'groceries.recipeSaved': 'Receta guardada',
  'groceries.recipeUpdated': 'Receta actualizada',
  'groceries.recipeDeleted': 'Receta eliminada',
  'groceries.deleteConfirm': '¿Eliminar receta?',
  'groceries.deleteItem': '¿Eliminar artículo?',
  'groceries.progress': 'Progreso de Compras',
  'groceries.noItems': 'No hay artículos en la lista de compras aún',
  'groceries.domain.Produce': 'Frutas y Verduras',
  'groceries.domain.Meat/Fish': 'Carnes/Pescado',
  'groceries.domain.Dairy': 'Productos Lácteos',
  'groceries.domain.Beverages': 'Bebidas',
  'groceries.domain.Pantry': 'Despensa',
  'groceries.domain.Bakery': 'Panadería',
  'groceries.domain.Frozen': 'Congelados',
  'groceries.domain.Other': 'Otro',}
