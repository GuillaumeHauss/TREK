const ru: Record<string, string> = {
  ...
  // Groceries
  'groceries.shopping': 'Список покупок',
  'groceries.recipes': 'Рецепты',
  'groceries.addItems': 'Добавить товары',
  'groceries.ustensils': 'Кухонная утварь',
  'groceries.newRecipe': 'Новый рецепт',
  'groceries.recipeName': 'Название рецепта',
  'groceries.description': 'Описание',
  'groceries.servings': 'Порции',
  'groceries.ingredients': 'Ингредиенты',
  'groceries.ingredientName': 'Название ингредиента',
  'groceries.quantity': 'Количество',
  'groceries.unit': 'Единица',
  'groceries.domain': 'Категория',
  'groceries.ustensilName': 'Название утвари',
  'groceries.save': 'Сохранить',
  'groceries.cancel': 'Отмена',
  'groceries.addToList': 'Добавить в список покупок',
  'groceries.sharedUstensils': 'Общая утварь',
  'groceries.noShared': 'Нет общей утвари в нескольких рецептах',
  'groceries.usedIn': 'Используется в {count} рецептах',
  'groceries.itemAdded': 'Товар добавлен',
  'groceries.recipeSaved': 'Рецепт сохранен',
  'groceries.recipeUpdated': 'Рецепт обновлен',
  'groceries.recipeDeleted': 'Рецепт удален',
  'groceries.deleteConfirm': 'Удалить рецепт?',
  'groceries.deleteItem': 'Удалить товар?',
  'groceries.progress': 'Ход покупок',
  'groceries.noItems': 'Пока нет товаров в списке покупок',
  'groceries.domain.Produce': 'Овощи и фрукты',
  'groceries.domain.Meat/Fish': 'Мясо/Рыба',
  'groceries.domain.Dairy': 'Молочные продукты',
  'groceries.domain.Beverages': 'Напитки',
  'groceries.domain.Pantry': 'Кладовая',
  'groceries.domain.Bakery': 'Булочная',
  'groceries.domain.Frozen': 'Замороженный',
  'groceries.domain.Other': 'Другое',
}
