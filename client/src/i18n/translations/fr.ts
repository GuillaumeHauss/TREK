const fr: Record<string, string> = {
  ...
  // Groceries
  'groceries.shopping': 'Liste d\'achats',
  'groceries.recipes': 'Recettes',
  'groceries.addItems': 'Ajouter des articles',
  'groceries.ustensils': 'Ustensiles',
  'groceries.newRecipe': 'Nouvelle recette',
  'groceries.recipeName': 'Nom de la recette',
  'groceries.description': 'Description',
  'groceries.servings': 'Portions',
  'groceries.ingredients': 'Ingrédients',
  'groceries.ingredientName': 'Nom de l\'ingrédient',
  'groceries.quantity': 'Quantité',
  'groceries.unit': 'Unité',
  'groceries.domain': 'Catégorie',
  'groceries.ustensilName': 'Nom de l\'ustensile',
  'groceries.save': 'Enregistrer',
  'groceries.cancel': 'Annuler',
  'groceries.addToList': 'Ajouter à la liste d\'achats',
  'groceries.sharedUstensils': 'Ustensiles partagés',
  'groceries.noShared': 'Aucun ustensile partagé entre plusieurs recettes pour le moment',
  'groceries.usedIn': 'Utilisé dans {count} recettes',
  'groceries.itemAdded': 'Article ajouté',
  'groceries.recipeSaved': 'Recette enregistrée',
  'groceries.recipeUpdated': 'Recette mise à jour',
  'groceries.recipeDeleted': 'Recette supprimée',
  'groceries.deleteConfirm': 'Supprimer la recette?',
  'groceries.deleteItem': 'Supprimer l\'article?',
  'groceries.progress': 'Progression des achats',
  'groceries.noItems': 'Aucun article dans la liste d\'achats pour le moment',
  'groceries.domain.Produce': 'Fruits et légumes',
  'groceries.domain.Meat/Fish': 'Viande/Poisson',
  'groceries.domain.Dairy': 'Produits laitiers',
  'groceries.domain.Beverages': 'Boissons',
  'groceries.domain.Pantry': 'Provisions',
  'groceries.domain.Bakery': 'Boulangerie',
  'groceries.domain.Frozen': 'Produits surgelés',
  'groceries.domain.Other': 'Autre',
}
