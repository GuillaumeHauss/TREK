const zh: Record<string, string> = {
  ...
  // Groceries
  'groceries.shopping': '购物清单',
  'groceries.recipes': '食谱',
  'groceries.addItems': '添加物品',
  'groceries.ustensils': '厨房用具',
  'groceries.newRecipe': '新食谱',
  'groceries.recipeName': '食谱名称',
  'groceries.description': '描述',
  'groceries.servings': '份量',
  'groceries.ingredients': '配料',
  'groceries.ingredientName': '配料名称',
  'groceries.quantity': '数量',
  'groceries.unit': '单位',
  'groceries.domain': '类别',
  'groceries.ustensilName': '用具名称',
  'groceries.save': '保存',
  'groceries.cancel': '取消',
  'groceries.addToList': '添加到购物清单',
  'groceries.sharedUstensils': '共享用具',
  'groceries.noShared': '多个食谱中还没有共享的用具',
  'groceries.usedIn': '用于 {count} 个食谱',
  'groceries.itemAdded': '物品已添加',
  'groceries.recipeSaved': '食谱已保存',
  'groceries.recipeUpdated': '食谱已更新',
  'groceries.recipeDeleted': '食谱已删除',
  'groceries.deleteConfirm': '删除食谱？',
  'groceries.deleteItem': '删除物品？',
  'groceries.progress': '购物进度',
  'groceries.noItems': '购物清单中还没有物品',
  'groceries.domain.Produce': '蔬菜水果',
  'groceries.domain.Meat/Fish': '肉类/鱼类',
  'groceries.domain.Dairy': '乳制品',
  'groceries.domain.Beverages': '饮料',
  'groceries.domain.Pantry': '食品储藏室',
  'groceries.domain.Bakery': '面包店',
  'groceries.domain.Frozen': '冷冻',
  'groceries.domain.Other': '其他',}
