const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Groceries
  'groceries.shopping': 'Einkaufsliste',
  'groceries.recipes': 'Rezepte',
  'groceries.addItems': 'Artikel hinzufügen',
  'groceries.ustensils': 'Küchenutensilien',
  'groceries.newRecipe': 'Neues Rezept',
  'groceries.recipeName': 'Rezeptname',
  'groceries.description': 'Beschreibung',
  'groceries.servings': 'Portionen',
  'groceries.ingredients': 'Zutaten',
  'groceries.ingredientName': 'Zutatname',
  'groceries.quantity': 'Menge',
  'groceries.unit': 'Einheit',
  'groceries.domain': 'Kategorie',
  'groceries.ustensilName': 'Utensil-Name',
  'groceries.save': 'Speichern',
  'groceries.cancel': 'Abbrechen',
  'groceries.addToList': 'Zur Einkaufsliste hinzufügen',
  'groceries.sharedUstensils': 'Gemeinsame Utensilien',
  'groceries.noShared': 'Noch keine Utensilien in mehreren Rezepten',
  'groceries.usedIn': 'Verwendet in {count} Rezepten',
  'groceries.itemAdded': 'Artikel hinzugefügt',
  'groceries.recipeSaved': 'Rezept gespeichert',
  'groceries.recipeUpdated': 'Rezept aktualisiert',
  'groceries.recipeDeleted': 'Rezept gelöscht',
  'groceries.deleteConfirm': 'Rezept löschen?',
  'groceries.deleteItem': 'Artikel löschen?',
  'groceries.progress': 'Einkaufsfortschritt',
  'groceries.noItems': 'Noch keine Artikel in der Einkaufsliste',
  'groceries.domain.Produce': 'Obst und Gemüse',
  'groceries.domain.Meat/Fish': 'Fleisch/Fisch',
  'groceries.domain.Dairy': 'Molkereiprodukte',
  'groceries.domain.Beverages': 'Getränke',
  'groceries.domain.Pantry': 'Vorratskammer',
  'groceries.domain.Bakery': 'Bäckerei',
  'groceries.domain.Frozen': 'Gefrorenes',
  'groceries.domain.Other': 'Sonstiges',}
