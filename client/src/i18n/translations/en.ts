const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Groceries
  'groceries.shopping': 'Shopping List',
  'groceries.recipes': 'Recipes',
  'groceries.addItems': 'Add Items',
  'groceries.newRecipe': 'New Recipe',
  'groceries.recipeName': 'Recipe name',
  'groceries.description': 'Description',
  'groceries.servings': 'Servings',
  'groceries.ingredients': 'Ingredients',
  'groceries.ustensils': 'Utensils',
  'groceries.ingredientName': 'Ingredient name',
  'groceries.quantity': 'Qty',
  'groceries.unit': 'Unit',
  'groceries.domain': 'Category',
  'groceries.ustensilName': 'Utensil name',
  'groceries.save': 'Save',
  'groceries.cancel': 'Cancel',
  'groceries.addToList': 'Add to Shopping List',
  'groceries.sharedUstensils': 'Shared Utensils',
  'groceries.noShared': 'No utensils shared across multiple recipes yet',
  'groceries.usedIn': 'Used in {count} recipes',
  'groceries.itemAdded': 'Item added',
  'groceries.recipeSaved': 'Recipe saved',
  'groceries.recipeUpdated': 'Recipe updated',
  'groceries.recipeDeleted': 'Recipe deleted',
  'groceries.deleteConfirm': 'Delete recipe?',
  'groceries.deleteItem': 'Delete item?',
  'groceries.progress': 'Shopping Progress',
  'groceries.noItems': 'No items in shopping list yet',
  'groceries.domain.Produce': 'Produce',
  'groceries.domain.Meat/Fish': 'Meat/Fish',
  'groceries.domain.Dairy': 'Dairy',
  'groceries.domain.Beverages': 'Beverages',
  'groceries.domain.Pantry': 'Pantry',
  'groceries.domain.Bakery': 'Bakery',
  'groceries.domain.Frozen': 'Frozen',
  'groceries.domain.Other': 'Other',
}
