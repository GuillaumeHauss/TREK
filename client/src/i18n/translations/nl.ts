const nl: Record<string, string> = {
  ...
  // Groceries
  'groceries.shopping': 'Boodschappenlijst',
  'groceries.recipes': 'Recepten',
  'groceries.addItems': 'Items toevoegen',
  'groceries.ustensils': 'Keukengerei',
  'groceries.newRecipe': 'Nieuw recept',
  'groceries.recipeName': 'Receptnaam',
  'groceries.description': 'Beschrijving',
  'groceries.servings': 'Porties',
  'groceries.ingredients': 'Ingrediënten',
  'groceries.ingredientName': 'Ingrediëntnaam',
  'groceries.quantity': 'Hoeveelheid',
  'groceries.unit': 'Eenheid',
  'groceries.domain': 'Categorie',
  'groceries.ustensilName': 'Keukengerei naam',
  'groceries.save': 'Opslaan',
  'groceries.cancel': 'Annuleren',
  'groceries.addToList': 'Toevoegen aan boodschappenlijst',
  'groceries.sharedUstensils': 'Gedeeld keukengerei',
  'groceries.noShared': 'Nog geen keukengerei gedeeld tussen meerdere recepten',
  'groceries.usedIn': 'Gebruikt in {count} recepten',
  'groceries.itemAdded': 'Item toegevoegd',
  'groceries.recipeSaved': 'Recept opgeslagen',
  'groceries.recipeUpdated': 'Recept bijgewerkt',
  'groceries.recipeDeleted': 'Recept verwijderd',
  'groceries.deleteConfirm': 'Recept verwijderen?',
  'groceries.deleteItem': 'Item verwijderen?',
  'groceries.progress': 'Boodschappenvoortgang',
  'groceries.noItems': 'Nog geen items in boodschappenlijst',
  'groceries.domain.Produce': 'Groenten en fruit',
  'groceries.domain.Meat/Fish': 'Vlees/Vis',
  'groceries.domain.Dairy': 'Zuivelproducten',
  'groceries.domain.Beverages': 'Dranken',
  'groceries.domain.Pantry': 'Inbouwkast',
  'groceries.domain.Bakery': 'Bakkerij',
  'groceries.domain.Frozen': 'Bevroren',
  'groceries.domain.Other': 'Ander',}
